...
<header style="z-index:10" id="menu" class="w-100 bg-white mx-0 <?php echo ($url != "/")? " fixed-top" : ""; ?>">
    <div class="h-100 row mx-0">
        <!--logo-->
        <div class="h-100 col-auto col-md-3 p-0 d-lg-block bordes">
            <a class="h-100 px-2 px-md-0 c-align-middle" href="/">
                <img style="height:90%" height="50px" class=" d-none d-md-block" src="/imagenes/fundación/logo.svg"/>

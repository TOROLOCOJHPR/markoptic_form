...
?>
<header id="menu" class="bg-white fixed-top mx-0 text-dark" style=" height:50px;">
        ...
        <div class="col-auto p-0 h-100 bordes">
            <a class="c-align-middle w-100 h-100 px-4 px-md-2 pointer" <?php echo $redireccion; ?> >
                ...
                <svg class="mr-md-2" height="33%" viewBox="0 0 448 512">
                    <path class="svg-dark" d="M257.5 445.1l-22.2 22.2c-9.4 9.4-24.6 9.4-33.9 0L7 273c-9.4-9.4-9.4-24.6 0-33.9L201.4 44.7c9.4-9.4 24.6-9.4 33.9 0l22.2 22.2c9.5 9.5 9.3 25-.4 34.3L136.6 216H424c13.3 0 24 10.7 24 24v32c0 13.3-10.7 24-24 24H136.6l120.5 114.8c9.8 9.3 10 24.8.4 34.3z"></path>
                </svg>
                <span class="d-none d-md-inline-block fs-1-2 text-dark">regresar</span>
            </a>
        </div>
    <!--inicio-->
        <div class="col-auto  p-0 h-100 bordes">
    ...
    <!-- nombre página -->
        <div class="col h-100 p-0 c-align-middle">
            <label class="mb-0 fs-1-2"><strong><?php echo $menuBack; ?></strong></label>
        </div>
    <!-- donar -->
        <div class="col-auto  d-none d-md-block h-100 px-0 bg-verde-menu">

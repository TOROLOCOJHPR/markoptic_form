...
<form class="px-4" method="post" enctype="multipart/form-data" action="">
    ...
    <div class="row">
        <div class="col-md-3">
            <label>Foto 1</label>
            <img class="img-fluid" src="/img/uploads/<?php echo $dato['foto1'] ?>">
            <input type="file" name="foto1" id="foto1" class="form-control-file">
        </div>
        <div class="col-md-3">
            <label>Foto 2</label>
            <img class="img-fluid" src="/img/uploads/<?php echo $dato['foto2'] ?>">
            <input type="file" name="foto2" id="foto2" class="form-control-file">
        </div>
        <div class="col-md-3">
            <label>Foto 3</label>
            <img class="img-fluid" src="/img/uploads/<?php echo $dato['foto3'] ?>">
            <input type="file" name="foto3" id="foto3" class="form-control-file">
        </div>
        <div class="col-md-3">
            <label>Foto Historia</label>
            <img class="img-fluid" id="srcFotoH" src="/img/uploads/beneficiados/<?php echo $dato['fotoHistoria'] ?>">

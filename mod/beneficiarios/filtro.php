<?php
    ...
    if( $metodo == "POST" ){ //metodo POST
        ...
        $pais =""; $estado =""; $ciudad =""; $sexo =""; $folio ="";
    }
?>

<div class="row mx-0" id="filtroBtn">
    <div class="px-2 text-white mr-0 position-absolute pointer c-align-middle" style="font-size:1.2rem;z-index:500;right:0;height:30px;margin-top:-30px;background-color:orange;"><span class="mr-2">Mostrar Filtros</span><i class="fa fa-filter" aria-hidden="true"></i></div>
</div>
<div class="container-fluid bg-secondary" id="filtroPanel" style="display:none;">
    ...
    <form class="" method="post" action="<?php $_SERVER['PHP_SELF'] . '?' . $_SERVER['QUERY_STRING'] ?>">
        ...
        <div class="row mx-0">
            <input class="btn text-white ml-auto mt-2 mb-4" style="background-color:orange;" value="Aplicar Filtro" type="submit">
        </div>
    </form>
</div>

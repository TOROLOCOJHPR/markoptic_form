...
?>
    ...
    <div class="col-12 col-md-4 mt-4 flex-column order-2 order-md-3 ">
        <div id='contCirculo' class="text-dark">
            <h5 class="text-center mt-4">Porcentaje de Recaudación</h5>
            <svg id="contPorcentaje" height='300' width='300' class="">
                <circle id='circulo' cx='50%' cy='50%' r='100' stroke-dasharray='628' stroke-dashoffset='<?php echo $dashoffset; ?>'></circle>
                <text id='porciento' class="svg-dark" x='34%' font-size='2.5rem' y='52%'><?php echo $porciento; ?>%</text>
            </svg>
            <h6 class="text-center">Precio dispositivo: <?php echo $precioProtesis; ?> MXN</h6>
            <h6 class="text-center">Total Recabado: <?php echo $recabado; ?> MXN</h6>
        </div><!--contCirculo-->
    </div>
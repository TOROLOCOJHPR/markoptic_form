<!-- modal final -->
<div id="modal-final" class="modal fade banwire" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog">

        <div class="modal-content p-3 px-5 text-center text-dark"> 

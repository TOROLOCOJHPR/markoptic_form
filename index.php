...
?>
                ...
                <cms:show_repeatable 'carouselfondo'>
                    <div class="carousel-item h-100 <cms:if k_count ='1'>active</cms:if>">
                        ...
                        <div class="carousel-caption w-100 text-center opacity-black">
                            <h4 class="t-shadow-2-black"><cms:show titulo /></h4>
                        </div>
                    </div>
                    </a>
                </cms:show_repeatable>
    ...
    <!--contador-->
        <div id="controlMenu" class='contador text-white px-2 px-md-4' style='height:50px;position:absolute;'>
            <span class="fs-2 d-inline" style="text-shadow:2px 2px 3px black;" id="contador" valor="<?php echo $valor;?>"></span>
            <span class="fs-2 d-inline" style="text-shadow:2px 2px 3px black;">&nbsp;Solicitudes</span>
        </div>
    ...
    <!-- beneficiarios -->
        <div class='row bg-dark bg-cover-center mx-0' style="position:relative;height:300px;background-image:url('<cms:show img_beneficiarios />');">
            <div class='capa-green-25 c-align-middle '>
                <a href="">
                    <h1 class='t-shadow-2-black text-center'>
                        <a href="/beneficiarios"><cms:show beneficiarios /></a>
                    </h1>
                </a>
            </div>
        </div><!--/beneficiarios -->
                ...
                <cms:pages masterpage='noticias.php' limit='3'>
                    <div class="carousel-item h-100 <cms:if k_count ='1'>active</cms:if>">
                        <a href="<cms:show k_page_link />">
                            ...
                            <div class="carousel-caption w-100 text-center opacity-black">
                                <h4 class="px-2 px-md-4 t-shadow-2-black"><cms:show k_page_title /></h4>
                            </div>
                        </a>
                    </div>
                </cms:pages>
